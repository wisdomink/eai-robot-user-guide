# Robot Interaction Procedures Guide
...
## Current Version (External Microphone)
...
## Upcoming Version (Built-in Microphone, OTA Update)
...
### Voice Command Actions and Expressions
...
You may contact the sales representative to submit your knowledge base customization request and ask for your business solution. In future updates, you will be able to configure and customize your interactive knowledge base, character profile, wake words, and voice tone selection directly through the FF EAI Robotic Robotics Intellectual & Interactive Platform (under development, will release soon).
