...
The FF MASTER Ultra also supports optional accessories such as the **OmniPicker,** as well as optional** teleoperation** and** charging station** modules.
- This model supports full secondary development and is also compatible with the the **Locomotion & Manipulation** Platform (under development, will release soon).
