...
The FF Master series includes three versions: FF Master, FF Master Edu and FF Master Ultra. Each version differs slightly in configuration and functional capability, with a total of 27–31 degrees of freedom (DOF) across the series, enabling precise motion and posture control. FF Master:
