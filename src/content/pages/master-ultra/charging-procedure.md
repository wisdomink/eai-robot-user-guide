...
![Magnetic Charging Port Location](/images/master-ultra/charging-1.png)
...
1. Power Off: Refer to the shutdown procedure described earlier.
2. Remove the Battery: Use two fingers to pull out the battery handle fixed on the front of the battery pack. Then insert your fingers into the handle loop and pull the handle strap outward to easily remove the battery.
3. Install the Battery: Follow the installation procedure described in the startup section.

![Pull the battery handle and extract the battery backward.](/images/master-ultra/battery-replacement-1.png)
