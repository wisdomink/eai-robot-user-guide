/**
 * Reads src/generated/aimdk-manifest.json and writes src/content/aimdk-sidebar.json
...
const OUT = path.join(ROOT, 'src/content/aimdk-sidebar.json')
...
async function main() {
  ...
  function buildLocale(locale) {
    ...
    return {
      title: locale === 'zh' ? 'AimDK（中文）' : 'AimDK (English)',
      basePath: prefix,
      sections,
    }
  }
