...
description: >-
  ...
  http://127.0.0.1:51011/rpc/aimdk.protocol.SystemService/GetSy…
product: a2-lite
version: v2-0
slug:
  - a2-lite
  - v2-0
  - system-status
route: /zh/a2-lite/v2-0/system-status
sourceUrl: 'https://open.agibot.com/docs/aimdk/a2-lite/v2_0/07-05-system_status'
order: 120
---
# 7.5 系统状态部分
...
-   cur\_status: 系统当前情况
 ...
 |
| 示例脚本 | examples/status/get\_system\_status.sh |
| 备注 |  |

### 7.5.3 BMS 状态获取 RPC 接口
...
-   battery\_comm\_state: 电池包通信状态
 ...
 |
| 示例脚本 | examples/status/get\_bms\_status.sh |
| 备注 |  |
...
其余字段无需关注 |
| 示例脚本 | examples/status/get\_estop\_status.sh |
| 备注 | 
...
其余字段无需关注 |
| 示例脚本 | examples/status/get\_version\_info.sh |
| 备注 |  |
