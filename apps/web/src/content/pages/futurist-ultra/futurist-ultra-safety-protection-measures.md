...
8. Confirm the Parking Location: Before entering the operating area, personnel must ensure that the robot is parked on level ground. Do not approach the robot while it is on a slope.

9. Restart after Shutdown: After shutting down, wait at least 30 seconds before powering the robot back on.
