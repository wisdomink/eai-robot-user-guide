...
Before using this product, users must carefully read the user manual and operate the product strictly in accordance with its contents. The company shall not be held liable for any property damage or personal injury resulting from the use of the product in violation of the instructions in this manual.

This product consists of multiple components. Please ensure that children cannot access the product to avoid accidents. This product is only for use by persons aged 18 and above.

To extend the product's service life, do not use it in high-temperature or high-pressure environments.
