...
![](/images/aegis/aegis-component-introduction-1.png)

## Expansion Interface (Applicable to Edu Version)

![](/images/aegis/aegis-component-introduction-2.png)
...
Disassembly and installation method: use the 2mm hex screwdriver included in the toolkit to loosen the four M4 screws in sequence and remove the cover plate. To reinstall, place the cover plate back and tighten the screws in order. Note: The expansion interfaces listed above are not included in FX Aegis Classic and Aegis Pro editions.
