...
VS_COUNT=0
for vs_var in OPENAI_VECTOR_STORE_MANUALS_ID OPENAI_VECTOR_STORE_MASTER_ID OPENAI_VECTOR_STORE_MASTER_MINI_ID \
              OPENAI_VECTOR_STORE_FUTURIST_ID OPENAI_VECTOR_STORE_FUTURIST_ULTRA_ID \
              OPENAI_VECTOR_STORE_AEGIS_ID OPENAI_VECTOR_STORE_AEGIS_ULTRA_ID OPENAI_VECTOR_STORE_AEGIS_MAX_ID \
              OPENAI_VECTOR_STORE_AEGIS_MEGA_D_ID OPENAI_VECTOR_STORE_AEGIS_HYPER_ID \
              OPENAI_VECTOR_STORE_FF91_ID OPENAI_VECTOR_STORE_NAVI_ID OPENAI_VECTOR_STORE_ROBOT_ALL_ID \
              OPENAI_VECTOR_STORE_PRICE_ID OPENAI_VECTOR_STORE_NEWS_ID; do
    val="${!vs_var:-}"
