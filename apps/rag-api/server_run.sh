...
for vs_var in OPENAI_VECTOR_STORE_MASTER_ULTRA_ID OPENAI_VECTOR_STORE_FUTURIST_ULTRA_ID \
              OPENAI_VECTOR_STORE_AEGIS_ULTRA_ID OPENAI_VECTOR_STORE_AEGIS_MAX_ID OPENAI_VECTOR_STORE_AEGIS_EDU_ID \
              OPENAI_VECTOR_STORE_FF91_ID OPENAI_VECTOR_STORE_ROBOT_ALL_ID OPENAI_VECTOR_STORE_MASTER_MINI_ID; do
    val="${!vs_var:-}"
