...
| 分类 | 内容 |
|------|------|
| 版本与安全 | 版本声明、法律声明、机器人与电池注意事项、开放网络端口 |
| 产品介绍 | 产品概述、组件名称、核心规格、灯效、扩展接口、运动模式 |
| 使用说明 | 环境要求、开箱、开机前检查与准备、启动操作、保护机制、载荷扩展、充电、运输、存储 |
| 遥控与应用 | 遥控器按键、功能说明、应用连接、模式切换与设置 |
| 售后支持 | 异常与解决方案、日常维护、保修政策 |
